...
//////////////////////////////////////////////////////////////////////////
static void __setupLimitsInv( ImVec2 * _pointsData, dz_timeline_limit_status_e _status, float _min, float _max, float * _factor, int32_t * _zoom, float * _y_min, float * _y_max )
{
    if( _status != DZ_TIMELINE_LIMIT_NORMAL )
    {
        float max_value = 0.f;
